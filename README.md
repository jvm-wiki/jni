...
- [Getting/Setting Fields](https://placeholder.com)
- [Calling Methods](https://placeholder.com)
- [Defining Classes](https://placeholder.com)

### External Resources
- [JNI Specification](https://docs.oracle.com/javase/8/docs/technotes/guides/jni/spec/jniTOC.html)
- [JNI Checklist](https://www.ibm.com/docs/en/sdk-java-technology/8?topic=jni-checklist)
